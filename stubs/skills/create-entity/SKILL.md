---
name: create-entity
description: Crea la entidad de dominio del módulo sin dependencias de framework.
---
...
- Usar nombres consistentes con el módulo.
- Guardar la entidad directamente en `domain/<entidad>.entity.ts` (sin carpeta `domain/entities`).
- Los nombres de entidad y atributos deben estar en ingles.
