...
if (fs.existsSync(appModulePath)) {
  fs.writeFileSync(
    appModulePath,
    "import { Module } from '@nestjs/common';\nimport { InfrastructureModule } from '@aurotek/nestjs-base/shared/infrastructure/infrastructure.module';\n\n@Module({\n  imports: [InfrastructureModule],\n  controllers: [],\n  providers: [],\n})\nexport class AppModule {}\n",
  );
}
